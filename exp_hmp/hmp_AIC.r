...
hmp_df = data.frame(read.csv("./data/hmp_v13lqphylotypePheno_rs_c.csv"))
# print(head(Xe_df))
# print(head(hmp_df))
...
# methods = list("QE_nSimplices_cMDS", "NB_nSimplices_cMDS", "QE_MDS_cMDS", "NB_MDS_cMDS", "NB_MDS", "QE_MDS")
methods = list("NB_MDS", "QE_MDS")
...
for (method in methods) {
    ...
    phenoSingleVector <- hmp_df[["THROAT"]]*1+hmp_df[["STOOL"]]*2+hmp_df[["MOUTH"]]*3+
                            ...
                            hmp_df[["ELBOWS"]]*6+hmp_df[["VAGINA"]]*7
