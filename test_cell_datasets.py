...
# Show plot
plt.savefig("./outputs/cell_dim.png")


# In[3]:

cells_reshaped = np.loadtxt("./datasets/cells_reshaped.txt")
...
plt.savefig("./outputs/cell_outlier_normal.png")
...
plt.savefig("outputs/cell_MDS.png")