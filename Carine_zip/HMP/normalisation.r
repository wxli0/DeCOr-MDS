...
print("=== Turn Counts into Z quantiles ===")
...
print("=== Counts into NB or E Quantiles ===")
...
write.table(v13lqphylotypeQuantE,file="./data/v13lqphylotypeQuantE_subset.csv",row.names=FALSE,col.names=FALSE,sep=",")
